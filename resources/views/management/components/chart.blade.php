...
<div class=" bg-white w-1/2 h-2/3 flex flex-col rounded-xl shadow-xl pt-5 pb-10 pl-8">
    ...
    <div class=" bg-gray-900 flex items-center justify-center px-5 py-5 w-11/12 rounded-xl mt-2">
