...
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900 lg:mx-32 md:mx-0">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 justify-between">
        ...
        {{-- right side footer --}}
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 md:mt-5">
            {{-- Resources Coloumn --}}
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Informasi</h2>
                <ul class="text-gray-600 dark:text-gray-400 grid grid-cols-1 gap-y-2">
                    <li>
                        <a href="https://flowbite.com/" class="hover:underline">Pengiriman</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" class="hover:underline">Kebijakan Privasi</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" class="hover:underline">Syarat & Ketentuan</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" class="hover:underline">Pengembalian</a>
                    </li>
                </ul>
            </div>
            ...
            {{-- Follow Us Coloumn --}}
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white text-center">Follow us
                </h2>
                <ul class="text-gray-600 dark:text-gray-400 grid grid-cols-2 place-items-center gap-y-3">
                    {{-- instagram --}}
                    <li>
                        <a href="#" class="hover:underline ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                                preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" class="">
                    ...
                    <li class="">
                        <a href="#" class="hover:underline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em"
                                preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                <path fill="currentColor" fill-opacity="0" stroke="currentColor" stroke-dasharray="62"
                                    stroke-dashoffset="62" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
            ...
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Jl. Mawar No.52, Tegalsari, Kec. Tegalsari, Kota
                            SBY,
                            60262</a>
                    </li>
                    <li>
                        <a href="#" class="hover:underline">0853 3437 2053</a>
                    </li>
                </ul>
            </div>
        </div>
