<x-app-layout>
    ...
    {{-- section untuk spinner and popover --}}
    <section class=" h-screen container flex">
        <div role="status">
    ...
    {{-- drawer --}}
    {{-- found bug at drawer when clicking empty space, click still disabled and background gray --}}
    <section class=" h-screen bg-cyan-400">
        <div>
            ...
            <div id="drawer-example" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800"
                ...
                <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">Supercharge your hiring by taking advantage of
                    ...
                    Flowbite Docs + Job Board. Unlimited access to over 190K top-ranked candidates and the #1 design job
                    board.</p>
    ...
    {{-- section for floating label --}}
    <div class=" w-full gap-20 grid grid-cols-3 bg-gray-800">
    ...
    {{-- carousel --}}
    <section class=" h-screen bg-slate-900 grid place-items-center">
        <div class=" relative h-1/3 w-1/3 bg-red-500">
            <div id="default-carousel" class="relative" data-carousel="static">
                <!-- Carousel wrapper -->
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96 bg-orange-400">
                    <!-- Item 1 -->
